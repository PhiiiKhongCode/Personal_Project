...
// identifiers (just like $parse)
     ...
     *
     */
    angular.module('ngResource', ['ng']).info({angularVersion: '1.8.2'}).provider('$resource', function ResourceProvider() {
    ...
    describe('resource', function () {
        ...
        describe('basic usage', function () {
            ...
            it('should update resource', function () {
                $httpBackend.expect('POST', '/CreditCard/123', '{"id":{"key":123},"name":"misko"}').respond({
                    id: {key: 123},
                    name: 'rama'
                });
            ...
            it('should patch a resource', function () {
                $httpBackend.expectPATCH('/CreditCard/123', '{"name":"igor"}').respond({id: 123, name: 'rama'});
            ...
            describe('promise api', function () {
                ...
                describe('single resource', function () {
                    ...
                    it('should allow promise chaining', function () {
                        ...
                        cc.$promise.then(function (value) {
                            return 'new value';
                        }).then(callback);
                        $httpBackend.flush();
                ...
                describe('resource collection', function () {
                    ...
                    it('should allow promise chaining', function () {
                        ...
                        ccs.$promise.then(function (value) {
                            return 'new value';
                        }).then(callback);
                        $httpBackend.flush();
            ...
            describe('suffix parameter', function () {
                ...
                describe('save', function () {
                    it('should append the suffix', function () {
                        $httpBackend.expect('POST', '/users.json', '{"name":"user1"}').respond({
                            id: 123,
                            name: 'user1'
                        });
                        var UserService = $resource('/users/:user_id.json', {user_id: '@id'});
                    ...
                    it('should append when an id is supplied', function () {
                        $httpBackend.expect('POST', '/users/123.json', '{"id":123,"name":"newName"}').respond({
                            id: 123,
                            name: 'newName'
                        });
                        var UserService = $resource('/users/:user_id.json', {user_id: '@id'});
        ...
        describe('handling rejections', function () {
            ...
            it('should not propagate exceptions in success callback to the returned promise', function () {
                ...
                $httpBackend.expectGET('/CreditCard/123').respond(null);
                var CreditCard = $resource('/CreditCard/:id');
                CreditCard.get({id: 123}, successCallbackSpy).$promise.then(promiseResolveSpy, promiseRejectSpy);
            ...
            it('should not be able to recover from inside the error callback', function () {
                ...
                var CreditCard = $resource('/CreditCard/:id');
                CreditCard.get({id: 123}, noop, errorCallbackSpy).$promise.then(promiseResolveSpy, promiseRejectSpy);
