        ...
        describe('basics', function () {
            ...
            it('should initialize view template after the view controller was initialized even when ' +
                ...
                inject(function ($rootScope, $compile, $location, $httpBackend, $route) {
                    ...
                    $location.path('/foo');
                    $httpBackend.expect('GET', 'viewPartial.html').respond('<div ng-init="log.push(\'init\')">' +
        ...
        describe('events', function () {
            ...
            it('should throw an error when a template is not found', function () {
                module(function ($routeProvider, $exceptionHandlerProvider) {
                    ...
                    $routeProvider.when('/r1', {templateUrl: 'r1.html'}).when('/r2', {templateUrl: 'r2.html'}).when('/r3', {templateUrl: 'r3.html'});
                });
                ...
                inject(function ($route, $httpBackend, $location, $rootScope, $exceptionHandler) {
                    ...
                    $httpBackend.flush();
                    expect($exceptionHandler.errors.pop()).toEqualMinErr('$templateRequest', 'tpload', 'Failed to load template: r1.html');
            ...
            describe('via `resolveRedirectTo`', function () {
                ...
                it('should be ignored if `redirectTo` is also present', function () {
                    ...
                    module(function ($routeProvider) {
                        ...
                        }).when('/bar', {template: 'Bar'}).when('/baz', {template: 'Baz'});
                    });
